...
const router = express.Router();
    ...
    /**
     * @module GraduationProcedureRoutes
     */

    /**
     * @name getGraduationProcedure
     * @path {GET} /api/v1/docs/graduation/student-procedure
     * 
     ...
     * 
     */
router.get('/student-file', //by sub.id
    ...
    /**
   * @name createGraduationProcedure
   * @path {POST} /api/v1/docs/graduation/start-procedure
   * 
   * @header {String} Authorization Bearer token (Student)
   * 
...
router.post('/start-procedure',
    ...
    /**
   * @name updateGraduationProcedure
   * @path {PATCH} /api/v1/docs/graduation
   *
   * @header {String} Authorization Bearer token (Student)
   *
...
router.patch('/',
    ...
    /**
   * @name deleteGraduationProcedure
   * @path {DELETE} /api/v1/docs/graduation/restart-procedure
   *
   * @header {String} Authorization Bearer token (Student)
   *
